...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_share = get_package_share_directory('dvrk_console')
    config_file_path = os.path.join(pkg_share, "config", config_name)
    ...
    # Delay the dvrk_console stereo viewer by 2.0 seconds to give the AR script
